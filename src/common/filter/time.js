...
export function simpleDateMinute(d, fallback = null) {
	if (d instanceof Date) {
...
//资讯时间
export function newsTime(d, fallback = null) {
  return d.format("EEE，MM月dd日，yyyy年")
}

//活动时间
export function activityTime(d, fallback = null) {
  return d.format("yyyy-MM-dd H:mm")
}

//有效期时间
export function termOfValidity (d, fallback = null) {
  return d.format("yyyy年MM月dd日前有效")
}

//活动时间
export function monthTime(d, fallback = null) {
  return d.format("MM月")
}
//资讯时间
...
//MM:dd
export function filterDay(d, fallback = null) {
  return d.format("MM:dd")
}
//hh:mm
...
//yyyy-MM-dd
export function allDay(d, fallback = null) {
  return d.format("yyyy-MM-dd")
}
